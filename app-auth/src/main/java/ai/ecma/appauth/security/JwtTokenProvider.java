...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(User user, Timestamp issuedAt) {
        Timestamp expireDate = new Timestamp(System.currentTimeMillis() + RestConstants.JWT_EXPIRED_TIME_FOR_ACCESS_TOKEN);
        //TODO JAHONGIR
    ...
    public String generateRefreshToken(User user) {
        ...
        Timestamp expireDate = new Timestamp(System.currentTimeMillis() + RestConstants.JWT_EXPIRED_TIME_FOR_REFRESH_TOKEN);
