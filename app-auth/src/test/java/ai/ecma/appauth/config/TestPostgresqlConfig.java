...
public class TestPostgresqlConfig {
    ...
    public JpaVendorAdapter jpaVendorAdapter() {
        ...
        hibernateJpaVendorAdapter.setDatabasePlatform(env.getProperty("spring.jpa.hibernate.dialect"));
        ...
        hibernateJpaVendorAdapter.setDatabase(Database.valueOf(Objects.requireNonNull(env.getProperty("spring.jpa.hibernate.dbType"))));
    ...
    public PostgresConfig postgresConfig() throws IOException {
        return new PostgresConfig(Version.V11_1,
                new AbstractPostgresConfig.Net(env.getProperty("spring.datasource.host"), Integer.parseInt(Objects.requireNonNull(env.getProperty("spring.datasource.port")))), //this is port for embedded virtual database see test profile properties
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ai.ecma.appauth.entity");
